...
client.connect(err => {
  ...
  const serviceCollection = client.db("Dogger").collection("service");
  const reviewCollection = client.db("Dogger").collection("review");
  const orderCollection = client.db("Dogger").collection("order");
  const adminCollection = client.db("Dogger").collection("admin");
